  ...
  return (
    <section id="services" className="pb-16">
      ...
      <h2 className="text-2xl font-bold text-ink-primary mb-8">
        Service{" "}
        <span className="text-accent">I Provide</span>
      </h2>
        ...
        {SERVICES.map((service, i) => (
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-sm font-semibold text-ink-primary">{service.title}</h3>
            </div>
            <p className="text-xs text-ink-secondary leading-relaxed">{service.description}</p>
          </motion.div>
        ))}
      </div>
    </section>
